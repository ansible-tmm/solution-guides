...
|---------|-------|-----------|
| Base image version (Tier 0) | Red Hat / community project | External releases |
...
- [AI-assisted Ansible development with MCP blog](<!-- TODO: replace with final blog 2 URL -->) -- how the MCP server brings AI-assisted development into governed workspaces
